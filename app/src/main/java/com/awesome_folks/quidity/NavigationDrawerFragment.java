...
public class NavigationDrawerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lblEmail = (TextView) getView().findViewById(R.id.lblEmailID);
    ...
    private class ActionBarDrawerToggleCompat extends ActionBarDrawerToggle {
        ...
        public ActionBarDrawerToggleCompat(FragmentActivity activity, DrawerLayout drawerLayout, Toolbar toolbar) {
            super(
                    activity,
        ...
        public void onDrawerSlide(View drawerView, float slideOffset) {
            ...
            ((MainActivity) getActivity()).slideFAB(slideOffset);
        }
    }
